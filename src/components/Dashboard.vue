      ...
      <v-row>
        ...
        <v-col cols="12" sm="12">
          <h6 class="text-center grey--text">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci dolorem dignissimos <br />
            Eos eligendi cupiditate cumque nemo sapiente quae omnis doloribus ducimus.
          </h6>
        </v-col>
        <v-col cols="12" sm="12">
